...
# Define a function to find the true by shifting the letter by the specified amount
...
def lasso_letter( letter, shift_amount ):
    ...
    #The njmber of letter in the alphabet
    alphabet_size = 26

    #The formula to calculate the ASCII numberfor the decoder letter
...
#Define a function to find the true in a secret message
# Shift the letters in a word by a specified amount to discover the hidden word
def lasso_word( word, shift_amount ):

#This variable is update each time another letter is decoded
    decoded_word = ""
    ...
    for letter in word:
        ...
        #The result (The decodedletter) is stored in a variable called decoded_letter
        decoded_letter = lasso_letter( letter, shift_amount )
        decoded_word = decoded_word + decoded_letter
    # The decoded_word is sent back to the lineof code that invoked this function
    return decoded_word
